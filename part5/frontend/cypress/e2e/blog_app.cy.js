describe('Blog app', function() {
  ...
  describe('when logged in', function() {
    ...
    it('can like a blog', function() {
      ...
      // Like the blog
      cy.contains('cypress title cypress author').parent().find('button').click()
  
      // Verify that the button text changes to "make not important"
      cy.contains('cypress title cypress author').parent().find('button')
    ...
    it('Non-creator cannot see delete button', function() {
      ...
      cy.request('POST', 'http://localhost:3003/api/users/', { name: 'Non-Creator User', username: 'noncreator', password: 'password' })
    ...
    it('Creator can see and delete the blog', function() {
      ...
      describe('Blog app', function() {
        beforeEach(function() {
          ...
          cy.createBlog({ title: 'Blog with 5 likes', author: 'Author 1', url: 'url1.com' })
          cy.createBlog({ title: 'Blog with 3 likes', author: 'Author 2', url: 'url2.com' })
          cy.createBlog({ title: 'Blog with 7 likes', author: 'Author 3', url: 'url3.com' })
        })
        ...
        it('Blogs are ordered by likes', function() {
          ...
          cy.get('.blog').then((blogs) => {
            const blogList = blogs.map((index, blog) => {
        ...
        it('Likes update changes the order', function() {
          ...
          cy.contains('Blog with 3 likes').parent().find('button').contains('like').click()
